...
import implementationClasses.BasicHashTableImpl;
import interfaces.HashTable;

public class MotorcycleOilChangeApp {
	//we will use a 12 piece socket set for this job
	private HashTable<String, String> toolset = new BasicHashTableImpl<>(12);
	...
	public void changeOil() {
		System.out.println("Building the tool set");
		buildToolset();
